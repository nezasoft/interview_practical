...
if(empty($errors)){
    ...
    $query = "UPDATE product SET prod_name='".$product."',prod_code='".$product_code."',min_amount='".$min_amount."',max_amount='".$max_amount."',currency_id='".$currency."' WHERE id ='".$item_id."' LIMIT 1";
    $ops->save($query);
    //save
}else{
