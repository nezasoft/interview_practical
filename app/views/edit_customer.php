...
$query = "SELECT * FROM customer WHERE id='".$item_id."' ORDER BY customer_name ASC  LIMIT 1";
    ...
    <div class="col-md-4">
        ...
        <hr/>
              ...
              <div class="form-group">
                ...
                <input type="text" value="<?php  echo $data_row['customer_name'];?> " autocomplete="off" class="form-control" id="Customer" placeholder="Enter Customer Name">
                <small id="customer_error" class="form-text text-muted"><font color="red">Enter Customer Name</font></small>
              </div>
              <div class="form-group">
                <label for="Email">Email</label>
                <input type="email" value="<?php  echo $data_row['email'];?>" autocomplete="off" class="form-control" id="Email" placeholder="Enter Email">
                <small id="email_error" class="form-text text-muted"><font color="red">Enter Email Address </font></small>
              </div>
              <div class="form-group">
                <label for="Date of Birth">Date of Birth</label>
                <input type="text" value="<?php  echo $data_row['dob'];?>" autocomplete="off" value="<?php echo date('Y-m-d');?>" class="form-control" id="Dob" placeholder="Enter Date of Birth">
                <small id="dob_error" class="form-text text-muted"><font color="red">Enter Date of birth</font></small>
              </div>
              <div class="form-group">
              <label for="Phone No">Phone No</label>
              <input type="text" value="<?php  echo $data_row['phone_no'];?>" autocomplete="off" class="form-control" id="Phone" placeholder="Enter Phone No">
              <small id="phone_error" class="form-text text-muted"><font color="red">Enter Phone No</font></small>
			  </div>
			  <div class="form-group">
              <label for="ID No">ID No</label>
              <input type="text" value="<?php  echo $data_row['id_no'];?>" autocomplete="off" class="form-control" id="IDNo" placeholder="Enter ID No">
              ...
              <input type="text" value="<?php  echo $data_row['phy_address'];?>" autocomplete="off" class="form-control" id="Physical" placeholder="Enter Physical Address">
...
$(document).ready(function(){
    ...
    $("#submit").click(function(){
		...
		$("#loader").show();
		//data values
		var myData =  'customer=' + customer +  '&email=' + email +  '&phone=' + phone +  '&idno=' + idno +  '&physical=' + physical  +  '&dob=' + dob +  '&item_id=' + item_id; //build a post data structure
		jQuery.ajax({
		type: "POST", // Post / Get method
		url: "process/update_customer.php", //Where form data is sent on submission
