...
$(document).ready(function(){
    ...
    $("#submit").click(function(){
		...
		$("#loader").show();
		//data values
		var myData =  'product=' + product +  '&product_code=' + product_code +  '&min_amount=' + min_amount  +  '&max_amount=' + max_amount +  '&int_rate=' + int_rate +  '&currency=' + currency; //build a post data structure
		jQuery.ajax({
